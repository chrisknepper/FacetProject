...
var mobiletimeline = require('./routes/mobiletimeline');
var mobileproduct = require('./routes/mobileproduct');
var mobilesocial = require('./routes/mobilesocial');
...
app.use('/mobiletimeline', mobiletimeline);
app.use('/mobileproduct', mobileproduct);
app.use('/mobilesocial', mobilesocial);
